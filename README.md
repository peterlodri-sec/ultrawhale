...
## Closing The Loop — v12.7.0

See [docs/case-study-v10.md](docs/case-study-v10.md) for the full case study of
ultrawhale building its own v12.7.0 release via subagent swarms.

One prompt → swarm launch → real PRs → meta-report → v12.7.0 tagged.
...
go build -ldflags="-X github.com/peterlodri-sec/ultrawhale/internal/build.Version=v12.7.0" ./cmd/whale
```

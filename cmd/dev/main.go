...
func (d devEnv) testWindows() error {
	steps := [][]string{
		...
		{"go", "test", "./internal/tools", "-run", "Test(ReadFileNormalizesCRLFContent|ReadFileDirectoryReturnsStableToolError|EditFileMatchesLFSearchAndPreservesCRLF|EditFilePreservesMixedLineEndings|MultiEditMatchesLFSearchAndPreservesCRLF|MultiEditPreservesMixedLineEndings|WindowsShellRunForegroundAndBackground|WindowsShellRunCancelKillsProcessTree|WindowsShellRunKeepsLaunchedChildOnSuccess|WindowsShellRunDecodesGBKStdout|WindowsShellRunPreservesAmbiguousValidUTF8Stdout|WindowsShellRunDecodesGBKStderrOnFailure|WindowsDecodeTextBytesDecodesGB18030WhenUTF8Invalid|WindowsReadFileDecodesGB18030Text|WindowsEditFilePreservesGB18030Bytes|WindowsEditFileMatchesVisibleGB18030Text|WindowsEditFilePreservesNonChineseLegacyBytes|WindowsGoSearchFallbackDecodesGB18030Text)$", "-count=1"},

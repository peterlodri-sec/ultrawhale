...
func (p *Plugin) registerRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/metrics", func(w http.ResponseWriter, r *http.Request) {
		...
		fmt.Fprintf(w, "# HELP ultrawhale_tool_latency_seconds Tool execution latency\n")
		fmt.Fprintf(w, "# TYPE ultrawhale_tool_latency_seconds histogram\n")
		fmt.Fprintf(w, "ultrawhale_tool_latency_seconds_bucket{le=\"0.1\"} 0\n")
		fmt.Fprintf(w, "ultrawhale_tool_latency_seconds_bucket{le=\"0.5\"} 0\n")
		fmt.Fprintf(w, "ultrawhale_tool_latency_seconds_bucket{le=\"1\"} 0\n")
		fmt.Fprintf(w, "ultrawhale_tool_latency_seconds_bucket{le=\"5\"} 0\n")
		fmt.Fprintf(w, "ultrawhale_tool_latency_seconds_bucket{le=\"+Inf\"} 0\n")
		fmt.Fprintf(w, "ultrawhale_tool_latency_seconds_count 0\n")
		fmt.Fprintf(w, "ultrawhale_tool_latency_seconds_sum 0\n")
	})

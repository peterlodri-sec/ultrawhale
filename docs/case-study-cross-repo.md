...
| [ultrawhale](https://github.com/peterlodri-sec/ultrawhale) | DeepSeek-native coding agent fork. 59 blocks, 7 plugins. | 91 releases in one session |
